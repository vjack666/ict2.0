...
**Rama de trabajo:** `feature/a5-audit-datos` (`da9d5ba`)
...
- `reports/audits/experiments/seq_ctx_01/gate_causal.json` (generado 2026-08-25T13:35,
  ...
  `usable_for_inference=true`. Hashes de `engine/mtf_navigation.py=2905f8…`,
  `engine/sequential_events.py=dc56cc…` registrados.
...
`feature/a5-audit-datos`/`main`, y (b) autorizar la ejecución de `EXP-WYCKOFF-ICT-01`
