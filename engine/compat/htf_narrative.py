"""Compatibility HTF narrative — non-authoritative reader.

Une los pedazos sueltos del motor ICT en UNA sola "idea del día":

    liquidez (objetivo)  ->  displacement/BOS  ->  POI (OB)  ->  premium/discount

Estado: COMPATIBILITY. La autoridad diaria vigente es ``engine.daily_motor``
con ``engine.mtf_navigation`` y el snapshot canónico. Este módulo se conserva
para consumidores antiguos y no puede redefinir Context State, AHF, LTF o
Wyckoff.
