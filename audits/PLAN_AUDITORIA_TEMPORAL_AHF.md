...
2. **Sandbox multi-ventana (ejecución histórica externa, 2026-08-20):** `reports/audits/temporal/ahf_temporal_navigation_SANDBOX.json` — 3 ventanas (2017/2020/2024), 170 steps, 51 invalidaciones, **rollback_depth max = 2.0**. Overall sandbox **PASS**. Valida el fix de instrumentación (`state_to_tf`). Runner: `scripts/tna_sandbox_runner.py`.
