...
El volumen es la columna vertebral del análisis Wyckoff. En distribución, la lectura de
...
2. **Fallos de breakout repetidos:** múltiples intentos de romper arriba del BC que revierten
   rápido. Cada uno es un intento UT/UTAD. El patrón acumula *breakouts fallidos*, no fuerza
   de breakout sostenida.
3. **Shrinking reaction quality:** cada rebote dentro del rango cubre menos distancia y tarda
   más velas en formarse. Volumen alto en subidas que dan ganancias de precio finas = el
...
- Reacciones bruscas a la resistencia.

> Regla de oro: la distribución es una batalla entre **vendedores informados** y
> **compradores desinformados**. El volumen te dice quién está ganando antes de que el
> precio lo confirme.
